...
/*	create table tbl_reply_goods(
	...
	public GoodsReplyListVO() {
		
	}

	public GoodsReplyListVO(int goodsNumber, String userId, int goodsReplyNumber, String goodsReplyContent,
			Date goodsReplyRegidate, String userNickname) {
		super();
